...
public class ConfigTest {
	...
	private static void initConfig() {
		try {
			...
			ReportTest.log(Status.WARNING, "Arquivo de configuração <b>config.properties</b> nao encontrado no projeto! <br/>" + ex.getMessage());
		}
	}
	...
	public static String get(String propertyName) {
		...
		if(propertyValue == null) {
			...
			ReportTest.log(Status.FATAL, errorMessage);
			return "";
		}
